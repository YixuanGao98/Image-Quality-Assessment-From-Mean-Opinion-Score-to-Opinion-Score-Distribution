...
class Network(torch.nn.Module):
    ...
    def __init__(self, scnn_root, options):
        ...
        self.features1 = torchvision.models.vgg16(pretrained=True).features#保存的是fc前面的网络结构，
...
class NetworkManager(object):
    def __init__(self, options, path):
        ...
        # Network.
        self._net = torch.nn.DataParallel(Network(self._path['scnn_root'], self._options), device_ids=[0]).cuda()
        print(self._net)
